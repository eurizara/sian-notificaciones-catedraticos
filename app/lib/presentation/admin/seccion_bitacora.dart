...
const List<({String valor, String etiqueta})> _tiposFiltrables =
    <({String valor, String etiqueta})>[
      ...
      (valor: 'DISPOSITIVO_REGISTRADO', etiqueta: 'Dispositivos registrados'),
      ...
      (valor: 'INVITACION_ACTUALIZADA', etiqueta: 'Invitaciones actualizadas'),
...
class _Asiento extends StatelessWidget {
  ...
  IconData _icono(String tipo) => switch (tipo) {
    ...
    'DISPOSITIVO_REGISTRADO' => Icons.phonelink_ring_outlined,
    ...
    'INVITACION_ACTUALIZADA' => Icons.drafts_outlined,
