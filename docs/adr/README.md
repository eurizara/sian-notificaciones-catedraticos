...
| ADR-009 | Varias sedes en un solo proyecto, con los datos separados por sede | Aceptada | [ADR-009](ADR-009-multisede.md) |
| ADR-010 | Repositorio de archivos con acceso por grupos y descarga por enlace temporal | Aceptada | [ADR-010](ADR-010-repositorio-archivos.md) |
